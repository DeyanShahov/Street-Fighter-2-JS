...
export class StatusBar {
    constructor (fighters) {
        ...
        this.frames = new Map ([
            ...
            [`${TIME_FRAME_KEYS[1]}-0`, [32, 192, 14, 16]],
            [`${TIME_FRAME_KEYS[1]}-1`, [16, 192, 14, 16]],
        ...
        this.name = [`tag-${name1.toLowerCase()}`, `tag-${name2.toLowerCase()}`];
    }


    drawFrame(context, frameKey, x, y, direction = 1) {
        drawFrameBase(context, this.image, this.frames.get(frameKey), x, y, direction);
    }
    ...
    drawScores(context) {
        ...
        this.drawScoreLabel(context, 'RED', 133);

...
import { FighterDirection, FighterState, FrameDelay, PUSH_FRICTION } from '../../constants/fighters.js';
...
export class Fighter {
    ...
    updateStageConstrains(time, context) {
    ...
    update(time, context) {
        ...
        this.updateStageConstrains(time, context);
    }
